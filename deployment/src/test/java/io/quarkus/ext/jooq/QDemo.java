...
import io.quarkus.ext.jooq.runtime.SQLDataTypeExt;
...
public class QDemo extends TableImpl<RDemo> {
    ...
    public final TableField<RDemo, String> id = createField("id", SQLDataType.CHAR(22).nullable(false).identity(true), this,
            "The PK");
    public final TableField<RDemo, String> name = createField("name", SQLDataType.VARCHAR(128).nullable(false), this,
            "The Name");
    public final TableField<RDemo, BigDecimal> amount = createField("amount", SQLDataType.NUMERIC(12, 3), this,
            "Amount Value");
    public final TableField<RDemo, Date> createdAt = createField("created_at", SQLDataTypeExt.UTILDATE.nullable(false),
            this, "Created At");
