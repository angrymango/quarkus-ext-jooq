...
/**
 * org.jooq.impl.SQLDataType.TIMESTAMP(XXX) to io.quarkus.ext.jooq.UTILDATE(XXX)
 *
...
public final class SQLDataTypeExt {
     ...
     */
    public static final DataType<java.util.Date> UTILDATEWITHTIMEZONE = new DefaultDataType<Date>(null, java.util.Date.class, "timestamptz");
}
